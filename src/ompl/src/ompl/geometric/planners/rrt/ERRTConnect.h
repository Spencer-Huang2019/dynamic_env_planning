...
#ifndef OMPL_ERRTCONNECT_H
#define OMPL_ERRTCONNECT_H
...
namespace ompl
{
    namespace geometric
    {
        /** \brief ERRT-Connect (ERRTConnect) */
        class ERRTConnect : public base::Planner
        {
        public:
            /** \brief Constructor */
            ERRTConnect(const base::SpaceInformationPtr &si, bool addIntermediateStates = false);
