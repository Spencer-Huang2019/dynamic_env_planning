...
class SamplingAlgorithm_uniform(ParameterizationAlgorithm):
    """
    ...
    def __init__(
        ...
        super(SamplingAlgorithm_uniform, self).__init__(
    ...
    def draw_static(self, samples):
        ...
        plt.savefig(
            "H:/2-writing/stopp_v13/picture/traj_sample/stopp/uniform/e10" + time.strftime('%Y%m%d_%H-%M-%S') + ".pdf")
        plt.show()
