...
#ifndef DYNAMIC_ENV_PLANNING_WRITE_TRAJECTORY_YAML_H
#define DYNAMIC_ENV_PLANNING_WRITE_TRAJECTORY_YAML_H
...
#endif //DYNAMIC_ENV_PLANNING_WRITE_TRAJECTORY_YAML_H
